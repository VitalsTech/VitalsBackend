...
1. Зарегистрироваться / войти (телефон+пароль **или Госуслуги** — `docs/Frontend-TZ-Esia.md`).
...
- Реальная аптека / ЕГИСЗ / оплата.
- Госуслуги на DEV: заглушка, ТЗ `docs/Frontend-TZ-Esia.md` (форма ФИО/почта/телефон; ОМС и адрес генерирует бэк; один аккаунт на телефон).
